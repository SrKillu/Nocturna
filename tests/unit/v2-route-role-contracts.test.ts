...
const ROUTE_CONTRACTS: readonly V2RouteContract[] = [
  ...
  },
  {
    ...
    primaryCapabilities: ['canViewCourses'],
  ...
  },
  {
    ...
    primaryCapabilities: ['canViewStudents'],
  ...
  },
  {
    ...
    allowedRoles: ACADEMIC_STAFF,
    primaryCapabilities: ['canViewStudentProfiles'],
    accessHelper: 'canAccessStudentProfileV2',
    canAccess: capabilityOnly(canAccessStudentProfileV2),
  },
  {
    path: '/v2/my-space',
    navHref: '/v2/my-space',
    allowedRoles: ['student'],
    primaryCapabilities: ['canViewOwnStudentProfile'],
    accessHelper: 'canAccessMySpaceV2',
    canAccess: canAccessMySpaceV2,
  },
  {
  ...
  },
  {
    ...
    allowedRoles: ACADEMIC_STAFF,
    primaryCapabilities: ['canViewAttendance'],
  ...
  },
  {
    ...
    allowedRoles: ACADEMIC_STAFF,
    primaryCapabilities: ['canViewEvaluations'],
  ...
  },
  {
    ...
    allowedRoles: ACADEMIC_STAFF,
    primaryCapabilities: ['canViewMaterials'],
  ...
  },
  {
    ...
    allowedRoles: ACADEMIC_STAFF,
    primaryCapabilities: ['canViewGradebook'],
  ...
  },
  {
    ...
    primaryCapabilities: ['canViewCertificates'],
  ...
  },
  {
    ...
    navHref: '/v2/staff',
    allowedRoles: INSTITUTION_ADMINS,
    primaryCapabilities: ['canViewStaff'],
  ...
  },
  {
    ...
    allowedRoles: INSTITUTION_ADMINS,
    primaryCapabilities: ['canViewEnrollments'],
