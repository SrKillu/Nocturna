...
-- REVIEW-ONLY BASELINE DRAFT. DO NOT APPLY.
-- This file represents the observed remote schema structure from C34.
-- It is not a migration.
-- It must not be copied into supabase/migrations without human review.
-- It must not be executed against remote Supabase.
-- No data rows are included.
-- No secrets are included.
--
-- Source: docs/schema-snapshots/C34_REMOTE_SCHEMA_READONLY_SNAPSHOT.sql
-- Purpose: disposable-database reconstruction review only.
-- This draft intentionally preserves observed differences, including weak
-- nullability, duplicate constraints, broad grants and permissive policies.
-- Those observations are evidence to reconcile, not approved target design.
