...
export default async function AdminTeachersPage() {
  ...
  return (
    <>
      <PageHeader
        title="Profesores"
        description="Gestiona los profesores de tu institución. Pueden crear cursos y calificar tareas."
      ...
      {teachers.length === 0 ? (
          ...
          <CardContent className="flex flex-col items-center gap-3 py-12 text-center">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Crea el primero para empezar a asignarlos a cursos.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Creados por admin desde este panel o invitados antes.
            </CardDescription>
          </CardHeader>
