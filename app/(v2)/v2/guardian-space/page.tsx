...
import { V2GuardianSpacePage } from '@/components/v2/guardian-space/v2-guardian-space-page';
...
import { getMockGuardianSpaceV2 } from '@/lib/mocks/guardian-space-v2';
import { canAccessGuardianSpaceV2 } from '@/lib/types/guardian-space-v2';

export default async function GuardianSpaceV2Page() {
  let session;
  ...
  return (
    <V2GuardianSpacePage
      guardianSpace={getMockGuardianSpaceV2(session.activeMembership.roleKey)}
    />
  );
}
