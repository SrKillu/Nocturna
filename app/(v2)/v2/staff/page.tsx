...
import { V2StaffPage } from '@/components/v2/staff/v2-staff-page';
...
import { getMockStaffV2 } from '@/lib/mocks/staff-v2';
import { canAccessStaffV2 } from '@/lib/types/staff-v2';

export default async function StaffV2Page() {
  let session;
  ...
  return <V2StaffPage staff={getMockStaffV2(session.activeMembership.roleKey)} />;
}
