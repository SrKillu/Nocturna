...
export function V2AttendanceHeader() {
  return (
    <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      <div>
        <div className="flex flex-wrap items-center gap-2">
          <h1 className="text-2xl font-semibold tracking-tight">Asistencia</h1>
          <Badge variant="outline">Fundación C10</Badge>
        </div>
        <p className="mt-1 text-sm text-muted-foreground">
          Consulta sesiones y señales de seguimiento para tus cursos visibles.
        </p>
      </div>
