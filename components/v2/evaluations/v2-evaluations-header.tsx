...
export function V2EvaluationsHeader() {
  return (
    <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
      <div>
        <div className="flex flex-wrap items-center gap-2">
          <h1 className="text-2xl font-semibold tracking-tight">Evaluaciones</h1>
          <Badge variant="outline">Fundación C11</Badge>
        </div>
        <p className="mt-1 text-sm text-muted-foreground">
          Consulta fechas, entregas y revisiones para tus cursos visibles.
        </p>
      </div>
